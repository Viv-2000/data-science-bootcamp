...
@app.route('/')
def homepage():
    message = "hello there mate. this is the root directory of your webapp. " \
    "to checkout ore features, try adding subdirectory to the address bar"  \
    " you may proceed to removing that then and try adding render_temp" \
    " keep experimenting to find out amzing things you can do through code"
    return message
